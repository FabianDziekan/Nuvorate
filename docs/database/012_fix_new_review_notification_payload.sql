...
comment on function public.create_new_review_notification() is
  'Creates a new_review notification with reviewId, authorName, rating and contentPreview in message JSON.';
